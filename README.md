...
<div align="center">
  ...
  [![Email](https://img.shields.io/badge/-Contato-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:yagosantossilva0@gmail.com)
...
const yago = {
    ...
    mindset:    "Construo produtos que geram receita",
    stack:      ["Java/Spring", "Python", "Flutter", "Angular", "IA/Automação"],
    services:   ["Apps sob demanda", "Automação de processos", "Bots inteligentes", "Sites & Landing Pages"],
    building:   ["SaaS próprios", "Soluções com IA", "Ferramentas de produtividade"],
    openTo:     "Projetos freelance · Parcerias · Sociedade · Clientes",
    contact:    "yagosantossilva0@gmail.com",
};
```
...
| 🔧 **Sistemas web** | Java/Spring Boot + Angular, REST API |
| 🤖 **Soluções com IA** | Integração Gemini, automação inteligente |
| 📊 **Dashboards & Dados** | Power BI, Chart.js, relatórios automatizados |
...
🔬  Pesquisador PICTA 2026 — Acessibilidade em Smart Homes
🤖  Google AI Essentials (2026)
🏅  40+ certificações DIO: Spring, Security, API REST, GoF, SOLID, IA
✈️  Ex-LATAM Airlines · Ex-Nike · Ex-Rappi
...
<div align="center">
  ...
  <img src="https://raw.githubusercontent.com/yago-silva-ads/yago-silva-ads/main/spider_noir.png" width="50" alt="Spider-Noir" />

  <sub><i>"Whatever dimension I'm in, I've got work to do."</i></sub>
